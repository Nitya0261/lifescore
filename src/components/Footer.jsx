  ...
  const cols = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Net Worth Tracker", path: "/tools/net-worth-tracker" },
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Find an Advisor", path: "/find-advisor" },
        { label: "Best Credit Cards", path: "/recommendations/credit-cards" },
        { label: "High-Yield Savings", path: "/recommendations/high-yield-savings" },
